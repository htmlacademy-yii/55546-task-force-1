    ...
    <ul class="menu-toggle__list">
        ...
        === Task::STATUS_NEW ? $currentItemClass : '' ?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <rect opacity="0.01" x="24" y="24" width="24" height="24"
                          transform="rotate(180 24 24)" fill="white"/>
                    <path
        ...
        === Task::STATUS_EXPIRED ? $currentItemClass : '' ?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <rect opacity="0.01" x="24" width="24" height="24"
                          transform="rotate(90 24 0)" fill="black"/>
                    <path fill-rule="evenodd" clip-rule="evenodd"
