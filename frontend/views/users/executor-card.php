...
<div class="content-view__feedback-card user__search-wrapper">
    <div class="feedback-card__top">
        ...
        <div class="feedback-card__top--name user__search-card">
            <p class="link-name">
                <?= Html::a(Html::encode($executor['login'] ?? ''), User::getUserUrl((int) $executor['id']), ['class' => 'link-regular']); ?>
            </p>
            ...
            <?php if ($executor['rating']): ?>
                ...
                <b><?= $executor['rating']; ?></b>
            <?php endif; ?>
            <p class="user__search-content"><?= Html::encode($executor['description'] ?? ''); ?></p>
        </div>
    ...
    <?php if ($executor['specializations']): ?>
        <div class="link-specialization user__search-link--bottom">
            <?php foreach (json_decode($executor['specializations']) as $specialization): ?>
                <?= Html::a(Html::encode($specialization->title), Task::getUrlTasksByCategory((int) $specialization->id), ['class' => 'link-regular']); ?>
            <?php endforeach; ?>
        </div>
    <?php endif; ?>
</div>
